<template>
	<div class="myOrder" >	
		<div class="orderList" v-for="(item,index) in dataList" :key='index'>
			...
			<div class="orderImg1" v-show="!item.status" >
				<form  @submit="changeStatus(index,item.lotyId,$event)"   report-submit='true'>
    	           <button  form-type="submit"></button>
    	        </form>
			</div>
			<div class="orderImg2" v-show="item.status" >
				<form   @submit="changeStatus(index,item.lotyId,$event)"  report-submit='true'>
    	           <button  form-type="submit"></button>
    	        </form>
			</div>
...
export default {
  ...
  methods: {
    ...
    changeStatus (index,lotyId,event) {
      var e = event;
...
.orderImg1 form button,
.orderImg2 form button{
	height: 100%;
	width: 100%;
	display: block;
